    ...
    return (
        <div>
            ...
            <div className="input-container">
                <input type="text" required autoComplete="off" onChange={nameHandler} value={recipeName} />
                <label htmlFor="">Nombre</label>
            </div>
            <div className="input-container">
                <input type="text" required autoComplete="off" onChange={instrucrionsHandler} value={recipeInstructions} />
            ...
            <div className="btn-container">
                <button className="btn btn-main" onClick={(e) => createRecipe(e)}>Create</button>
            </div>
            </form>
        </div>
    )
